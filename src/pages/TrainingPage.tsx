...
export const TrainingPage: React.FC<TrainingPageProps> = ({
  ...
  return (
    <div className="relative">
      ...
      <section className="py-20 bg-[#020617] border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-12">
            <div className="text-emerald-400 font-tech text-xs uppercase tracking-wider font-semibold mb-2">
      ...
      <section className="py-16 bg-gradient-to-r from-emerald-950/40 via-cyan-950/30 to-emerald-950/40 border-t border-white/10 text-center">

...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  return (
    <div className="relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-14 gap-6">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-cyan-400 text-[10px] font-bold tracking-widest uppercase mb-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-blue-600/15 hover:bg-blue-600/25 border border-blue-500/30 text-cyan-300 text-xs font-semibold uppercase tracking-wider transition-all hover:scale-[1.02] self-start md:self-auto"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {divisions.map((div) => {
              ...
              return (
                <div
                  key={div.id}
                  className="p-6 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-blue-500/40 transition-all duration-300 flex flex-col justify-between group hover:bg-white/[0.04]"
                >
                  <div>
                    ...
                    <h3 className="font-display font-bold text-lg text-white mt-1 mb-3 group-hover:text-cyan-300 transition-colors">
                      {div.title}
                    </h3>
      ...
      <section className="py-20 bg-gradient-to-b from-[#020617] via-blue-950/20 to-[#020617] relative border-t border-white/5 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="p-8 sm:p-12 rounded-3xl bg-white/[0.02] border border-blue-500/20 relative overflow-hidden backdrop-blur-xl">
            <div className="absolute top-0 right-0 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl pointer-events-none" />

            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-7">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-cyan-300 text-[10px] font-bold tracking-widest uppercase mb-4">
                  <Sparkles className="w-3.5 h-3.5" />
                  <span>Flagship Innovation Spotlight</span>
                </div>

                <h2 className="font-display font-black text-2xl sm:text-3xl md:text-4xl text-white tracking-tight mb-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-8">
                  <div className="p-3 rounded-xl bg-white/5 border border-white/10">
                    ...
                    <div className="text-[11px] text-slate-400">Digital Chain of Custody</div>
                  </div>
                  <div className="p-3 rounded-xl bg-white/5 border border-white/10">
                    <div className="text-blue-400 font-extrabold text-xl">&lt; 2 hrs</div>
                    <div className="text-[11px] text-slate-400">Average Claim Match</div>
                  </div>
                  <div className="p-3 rounded-xl bg-white/5 border border-white/10">
                    <div className="text-emerald-400 font-extrabold text-xl">Zero</div>
                    <div className="text-[11px] text-slate-400">Manual Paper Logging</div>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <button
                    ...
                    className="px-6 py-3 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 text-slate-200 hover:text-white font-semibold text-xs transition-all"
                  >
              ...
              <div className="lg:col-span-5 flex justify-center">
                <div className="w-full max-w-md p-6 rounded-2xl bg-[#030b1e] border border-cyan-500/30 shadow-[0_0_35px_rgba(6,182,212,0.15)] relative">
      ...
      <section className="py-20 bg-[#020617] relative border-t border-white/5">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="p-10 sm:p-14 rounded-3xl bg-gradient-to-r from-blue-950/40 via-cyan-950/30 to-blue-950/40 border border-blue-500/30 shadow-[0_0_50px_rgba(59,130,246,0.15)]">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              <button
                ...
                className="px-8 py-3.5 rounded-full bg-white/5 hover:bg-white/10 border border-white/15 text-slate-200 hover:text-white font-semibold text-xs transition-all"
              >

...
export const FounderSection: React.FC<FounderSectionProps> = ({
  ...
  return (
    <section id="founder" className="relative py-20 bg-slate-50 dark:bg-[#020617] border-t border-slate-200 dark:border-white/5 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto rounded-3xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 p-6 sm:p-10 shadow-sm dark:shadow-2xl relative overflow-hidden backdrop-blur-sm">
            ...
            <div className="lg:col-span-4 flex flex-col items-center text-center">
              <div className="relative group mb-5">
                ...
                <div className="w-48 h-48 sm:w-56 sm:h-56 rounded-3xl p-1 bg-gradient-to-tr from-blue-500 via-cyan-400 to-sky-400 shadow-[0_0_35px_rgba(59,130,246,0.3)]">
                  <div className="w-full h-full rounded-[22px] bg-slate-50 dark:bg-[#020617] flex flex-col items-center justify-center p-4 relative overflow-hidden">
                    {/* Abstract Tech Silhouette Graphic */}
                    <div className="w-24 h-24 rounded-2xl bg-blue-100 dark:bg-blue-500/20 border border-blue-200 dark:border-blue-500/30 flex items-center justify-center mb-3">
                    ...
                    <span className="font-tech text-xs text-blue-600 dark:text-blue-400 mt-0.5 uppercase tracking-wider font-semibold">
                      {FOUNDER_INFO.role}
                    </span>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-2 -right-2 px-3 py-1 rounded-full bg-white dark:bg-[#020617] border border-blue-300 dark:border-blue-500/50 text-blue-700 dark:text-blue-300 text-[11px] font-tech font-bold flex items-center gap-1.5 shadow-lg">
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  className="p-2.5 rounded-full bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-white/10 border border-slate-200 dark:border-white/10 transition-colors shadow-sm"
            ...
            <div className="lg:col-span-8 text-left space-y-4">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <span className="font-tech text-xs font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wider">
              ...
              {/* Mission Quote */}
              <div className="p-4 rounded-2xl bg-blue-50 dark:bg-blue-500/10 border-l-4 border-blue-600 dark:border-blue-500 text-blue-900 dark:text-blue-200 text-xs sm:text-sm italic backdrop-blur-sm">
                "{FOUNDER_INFO.missionStatement}"
              </div>

              {/* Core Skill Chips */}
              <div className="pt-2">
                <div className="font-tech text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {FOUNDER_INFO.skills.map((skill, idx) => (
                    <span
                      key={idx}
                      className="px-2.5 py-1 rounded-md bg-slate-100 dark:bg-white/5 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-white/10 text-xs font-tech"
                    >
                      {skill}
                    </span>
                  ))}

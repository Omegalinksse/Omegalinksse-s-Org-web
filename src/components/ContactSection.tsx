...
export const ContactSection: React.FC<ContactSectionProps> = ({
  ...
  return (
    <section id="contact" className="relative py-20 bg-[#020617] border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7">
            <div className="p-6 sm:p-8 rounded-3xl bg-white/5 border border-white/10 shadow-2xl text-left backdrop-blur-sm">
              {submitted ? (
                <div className="py-12 text-center space-y-4">
                  <div className="w-16 h-16 rounded-full bg-blue-500/20 text-blue-400 border-2 border-blue-500/50 mx-auto flex items-center justify-center animate-in zoom-in-75 duration-300">
                  ...
                  <p className="text-xs sm:text-sm text-slate-300 max-w-md mx-auto leading-relaxed">
                    Thank you, <strong className="text-blue-300">{formData.fullName}</strong>. Your inquiry regarding <strong className="text-white">{formData.service || formData.division}</strong> has been registered. An Omegalinks representative or Anehi Godwin Ohinoyi will review your specifications and contact you shortly.
                  </p>
                  <div className="pt-4 flex justify-center gap-3">
                    <button
                      onClick={() => setSubmitted(false)}
                      className="px-5 py-2.5 rounded-full bg-white/5 border border-white/10 text-slate-200 text-xs font-bold uppercase tracking-wider hover:bg-white/10"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-5 py-2.5 rounded-full bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold uppercase tracking-wider flex items-center gap-1.5"
                    >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-[11px] font-tech text-slate-300 uppercase tracking-wider mb-1">
                        Full Name *
                      </label>
                      <input
                        type="text"
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-xs text-white placeholder:text-slate-500 focus:border-blue-500 focus:outline-none"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className="w-full px-3.5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-xs text-white focus:border-blue-500 focus:outline-none"
                      >
                        <option value="digital-technology" className="bg-[#020617] text-white">01. Digital Technology (Software & Web)</option>
                        <option value="creative-media" className="bg-[#020617] text-white">02. Creative Digital Media (Design & Video)</option>
                        <option value="skills-training" className="bg-[#020617] text-white">03. Digital Skills & Training (Academy)</option>
                        <option value="growth-solutions" className="bg-[#020617] text-white">04. Digital Growth & Solutions (Strategy)</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-xs text-white focus:border-blue-500 focus:outline-none"
                      >
                        <option value="Urgent (1-2 weeks)" className="bg-[#020617] text-white">Urgent (1 - 2 weeks)</option>
                        <option value="Standard (2-6 weeks)" className="bg-[#020617] text-white">Standard (2 - 6 weeks)</option>
                        <option value="Long Term (2+ months)" className="bg-[#020617] text-white">Long Term (2+ months)</option>
                        <option value="Immediate Enrollment" className="bg-[#020617] text-white">Immediate Training Cohort</option>
                      </select>
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-xs text-white focus:border-blue-500 focus:outline-none"
                      >
                        <option value="Flexible / To Be Discussed" className="bg-[#020617] text-white">Flexible / To Be Discussed</option>
                        <option value="Starter / Student Training" className="bg-[#020617] text-white">Starter / Student Training</option>
                        <option value="Business / SME Solution" className="bg-[#020617] text-white">Business / SME Solution</option>
                        <option value="Enterprise / Institutional" className="bg-[#020617] text-white">Enterprise / Institutional</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-xs text-white placeholder:text-slate-500 focus:border-blue-500 focus:outline-none resize-none"
                    />
                  </div>
